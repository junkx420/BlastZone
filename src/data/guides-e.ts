...
export const E_GUIDES: FighterGuide[] = [
  ...
  RICHTER,
  {
    ...
    combos: [
      ...
      {
        id: 'littlemac-fthrow-haymaker',
        kind: 'bnb',
        title: 'Forward Throw → Jolt Haymaker',
        start: 0,
        window: [0, null],
        difficulty: 1,
        steps: [
      ...
      {
        id: 'littlemac-fair-haymaker',
        kind: 'meta',
        title: 'Forward Air → Jolt Haymaker (offstage)',
        start: 60,
      ...
      },
      {
        ...
        steps: [
          { input: 'utilt', dmg: 8 },
          { input: 'nb', label: 'KO-Uppercut', dmg: 42, note: 'Nur mit gefülltem Power-Meter.' },
        ],
        tip: 'Laut SmashWiki combot der Up Tilt bei niedrigen bis mittleren Prozenten sowohl in den Rising Uppercut als auch in den KO-Uppercut. Mit gefülltem Meter beendet das den Stock vor 40 %.',
        tags: ['Power-Meter gefüllt'],
        source: wiki('Little_Mac_(SSBU)'),
      },
      {
    ...
    combos: [
      ...
      },
      {
        ...
        steps: [
          { input: 'grab', dmg: 0 },
          { input: 'dthrow', dmg: 8 },
          { input: 'fh nair', label: 'FH Nair', dmg: 23, note: 'Beide Tritte gerechnet: 7 % plus 12 %, laut SmashWiki verbindet der erste Tritt in den zweiten.' },
        ],
      ...
      },
      {
        id: 'ganon-nair-ftilt',
        kind: 'bnb',
        title: 'Nair (später Treffer) → Forward Tilt',
        start: 30,
        windowLabel: 'niedrige bis mittlere Prozente',
        difficulty: 2,
        steps: [
      ...
      {
        id: 'ganon-flamechoke-fsmash',
        kind: 'meta',
        title: 'Flame Choke → Forward Smash',
        start: 60,
        windowLabel: 'als Read, nicht garantiert',
        kills: true,
        difficulty: 2,
        steps: [
      ...
      },
      {
        ...
        tip: 'Laut Game8 eine der drei einfachen Routen für niedrige Prozente. SmashWiki zählt die Dash Attack ebenfalls zu den Folgen des Down Throws.',
        source: game8('281196'),
      },
      {
        id: 'ganon-da-nair',
        ...
        tip: 'Laut Game8 eine einfache Route für niedrige Prozente.',
        source: game8('281196'),
      },
      {
        id: 'ganon-dthrow-uair',
        kind: 'bnb',
        ...
        tip: 'Laut SmashWiki führt der Down Throw von 0 % bis zu mittleren Prozenten in Dash Attack, Nair, Forward Air, umgedrehten Back Air, Up Air und Wizard’s Foot.',
        source: wiki('Ganondorf_(SSBU)'),
      },
      {
        id: 'ganon-dthrow-wizardsfoot',
        kind: 'bnb',
        title: 'Down Throw → Wizard’s Foot',
        start: 20,
        windowLabel: '0 % bis mittlere Prozente',
        difficulty: 2,
        steps: [
          { input: 'grab', dmg: 0 },
          { input: 'dthrow', dmg: 8 },
          { input: 'db', label: 'Wizard’s Foot', dmg: 17, note: 'Mit dem Bein gerechnet, trifft der Fuß, sind es 19 %.' },
        ],
        tip: 'Laut SmashWiki eine der Folgen aus dem Down Throw bis zu mittleren Prozenten.',
        source: wiki('Ganondorf_(SSBU)'),
      },
    ],
  },
