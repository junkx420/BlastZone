...
export const C_MINUS_GUIDES: FighterGuide[] = [
  ...
  },
  {
    ...
    combos: [
      ...
      },
      {
        id: 'jiggly-jab-da-ko',
        kind: 'meta',
        title: 'Jab → Dash Attack',
        start: 90,
        windowLabel: 'ungewöhnlich niedrige Kill-Prozente',
        kills: true,
        difficulty: 2,
        steps: [
          { input: 'jab', label: 'Jab (beide Treffer)', dmg: 7 },
          { input: 'da', label: 'Dash Attack, früher Treffer', dmg: 14 },
        ],
        tip: 'Laut SmashWiki verbindet der Jab in den Dash Attack, und der killt bei ungewöhnlich niedrigen Prozenten.',
        source: wiki('Jigglypuff_(SSBU)'),
      },
      {
        id: 'jiggly-ftilt-jab',
        kind: 'bnb',
        title: 'Forward Tilt → Jab',
        start: 10,
        windowLabel: 'niedrige Prozente',
        difficulty: 1,
        steps: [
        ...
        tip: 'Laut SmashWiki verbindet der Forward Tilt in Grab und Jab und kann bei niedrigen Prozenten locken.',
        source: wiki('Jigglypuff_(SSBU)'),
      },
      {
        id: 'jiggly-rising-dair-rest',
        kind: 'meta',
        title: 'Down Air im Aufsteigen → Rest („Rising Dair Rest“)',
        start: 60,
        windowLabel: 'enges Fenster, je nach Gegner',
        kills: true,
        difficulty: 3,
        steps: [
          { input: 'sh dair', label: 'Dair im Aufsteigen', dmg: 2, note: 'Pro Treffer. Wie viele sitzen, hängt am Timing.' },
          { input: 'jump db', label: 'Sprung gepuffert → Rest', dmg: 24 },
        ],
        tip: 'Laut SmashWiki der zweite große Rest-Confirm aus dem Down Air neben dem Drill Rest: aufsteigend den Down Air, dann Sprung und Rest puffern. Das Prozentfenster ist eng und von Gegner zu Gegner verschieden.',
        source: wiki('Jigglypuff_(SSBU)'),
      },
    ],
  },
  {
    ...
    combos: [
      ...
      {
        id: 'chrom-nair-fair-fair',
        kind: 'bnb',
        title: 'Nair → Forward Air ×2',
        start: 10,
        windowLabel: 'niedrige Prozente',
        difficulty: 3,
        steps: [
          { input: 'nair', label: 'Nair', dmg: 6, note: 'Game8 nennt nicht, welcher Nair-Treffer. Gerechnet ist der erste.' },
          { input: 'fair', label: 'Fair', dmg: 11 },
          { input: 'fair', label: 'Fair', dmg: 11 },
        ],
        tip: 'Laut Game8 gegen Gegner mit wenig Schaden, braucht aber etwas Übung.',
        source: game8('281239'),
      },
      {
        id: 'chrom-nair-soaring',
        kind: 'meta',
        title: 'Nair → Soaring Slash',
        start: 80,
        ...
        tip: 'Laut Game8 von mittleren bis hohen Prozenten. SmashWiki führt Folgen aus Nair oder Forward Air in Soaring Slash unter dem Namen „Chrombo".',
        source: game8('281239'),
      },
      {
        id: 'chrom-nair-fsmash',
        kind: 'meta',
        ...
        steps: [
          { input: 'nair', label: 'Nair', dmg: 6, note: 'Game8 nennt nicht, welcher Nair-Treffer. Gerechnet ist der erste.' },
          { input: 'fsmash', label: 'Forward Smash', dmg: 22 },
        ],
        tip: 'Laut Game8 geht die Folge, weil Chroms Forward Smash schnell herauskommt, und sie kann killen.',
        source: game8('281239'),
      },
    ],
  },
  {
    ...
    combos: [
      ...
      },
      {
        ...
        difficulty: 3,
        steps: [
          { input: 'sh bair ff', label: 'SH Bair, erster Treffer', dmg: 6 },
          { input: 'bair ff', label: 'Bair, erster Treffer', dmg: 6 },
          { input: 'bair ff', label: 'Bair, erster Treffer', dmg: 6 },
        ],
        tip: 'Laut Game8 nach jedem Back Air sofort fast fallen. Am Ende passt sogar noch der Spin Attack in der Luft.',
        source: game8('281037'),
      },
      {
        id: 'link-nair-jab',
        kind: 'bnb',
        title: 'Nair → Fast Fall → Jab',
        start: 20,
        difficulty: 2,
        steps: [
          { input: 'sh nair ff land', label: 'SH Nair, fallend', dmg: 13 },
          { input: 'jab', label: '3-Treffer-Jab', dmg: 12 },
        ],
        tip: 'Laut Game8 gut beim eigenen Anlauf und genauso, wenn der Gegner auf Link zukommt.',
        source: game8('281037'),
      },
      {
        id: 'link-dtilt-spin',
      ...
      },
      {
        ...
        difficulty: 3,
        steps: [
          { input: 'sh bair land', label: 'Back Air, 1. Treffer, dann landen', dmg: 6 },
          { input: 'ub', label: 'Spin Attack', dmg: 17 },
        ],
  ...
  },
  {
    ...
    combos: [
      ...
      },
      {
        ...
        steps: [
          { input: 'utilt', dmg: 13 },
          { input: 'fh fair', label: 'FH Fair', dmg: 16, note: 'Äußere Hitbox gerechnet, nah 13 %.' },
        ],
        tip: 'Laut SmashWiki führt der Up Tilt bei niedrigen Prozenten in Forward, Neutral und Up Air.',
        source: wiki('Bowser_(SSBU)'),
      },
      {
        id: 'bowser-utilt-uair',
        kind: 'bnb',
      ...
      {
        id: 'bowser-nair-usmash',
        kind: 'bnb',
        title: 'Nair (Landung) → Up Smash',
        start: 10,
        windowLabel: 'schon bei niedrigen Prozenten',
        difficulty: 2,
        steps: [
          { input: 'sh nair land', label: 'SH Nair, landen', dmg: 7 },
          { input: 'usmash', label: 'Up Smash (Sweetspot)', dmg: 26 },
        ],
        tip: 'Laut SmashWiki ist der gelandete Nair Bowsers bester Combo-Starter und verbindet schon bei niedrigen Prozenten in Up Tilt und Up Smash.',
        source: wiki('Bowser_(SSBU)'),
      },
      {
        id: 'bowser-nair-bair-ko',
        kind: 'meta',
        title: 'Nair (Landung) → Back Air',
        start: 100,
        windowLabel: 'Kill-Prozente',
        kills: true,
        difficulty: 2,
        ...
        tip: 'Laut SmashWiki öffnet der gelandete Nair KO-Confirms in Forward, Back und Up Air.',
        source: wiki('Bowser_(SSBU)'),
      },
      {
        id: 'bowser-uthrow-fair',
        kind: 'bnb',
        ...
        tip: 'Laut SmashWiki verbindet der Up Throw bei niedrigen Prozenten in Forward, Neutral und Up Air. Der Down Throw hat dagegen keine Folgen.',
        source: wiki('Bowser_(SSBU)'),
      },
      {
        id: 'bowser-uthrow-uair',
        kind: 'bnb',
        title: 'Up Throw → Up Air',
        start: 10,
        windowLabel: 'niedrige Prozente',
        ...
        tip: 'Laut SmashWiki verbindet der Up Throw bei niedrigen Prozenten in Forward, Neutral und Up Air.',
        source: wiki('Bowser_(SSBU)'),
      },
      {
        id: 'bowser-usmash-landing-bair-ko',
        kind: 'meta',
        title: 'Up Smash (Landetreffer) → Back Air',
        start: 100,
        windowLabel: 'Kill-Prozente',
        kills: true,
        difficulty: 3,
        steps: [
          { input: 'usmash', label: 'Up Smash, nur der Landetreffer', dmg: 14 },
          { input: 'fh bair', label: 'FH Bair', dmg: 23 },
        ],
        tip: 'Laut SmashWiki verbessert der schwächere Landetreffer des Up Smash dessen Combo-Potenzial und ergibt ein KO-Setup in den Back Air.',
        source: wiki('Bowser_(SSBU)'),
      },
    ],
  },
  ...
  },
  {
    ...
    combos: [
      ...
      {
        id: 'kirby-fthrow-nair',
        kind: 'bnb',
        title: 'Forward Throw → Nair',
        start: 10,
        windowLabel: 'niedrige Prozente',
        difficulty: 1,
        steps: [
      ...
      },
      {
        id: 'kirby-da-ko',
        kind: 'meta',
        title: 'Dash Attack (sauberer Treffer) an der Kante',
        start: 100,
        window: [100, null],
        kills: true,
        difficulty: 1,
      ...
      },
      {
        ...
        tip: 'Laut SmashWiki holt der Back Throw Mittelgewichte an der Kante ab etwa 140 %; der Up Throw braucht rund 160 %, wirkt dafür überall auf der Stage gleich.',
        tags: ['An der Kante'],
        source: wiki('Kirby_(SSBU)'),
      },
      {
      ...
      },
      {
        ...
        tip: 'Laut SmashWiki gehört der Forward Air bei niedrigen Prozenten zu den verlässlichsten Folgen aus dem Forward Throw.',
        source: wiki('Kirby_(SSBU)'),
      },
      {
        id: 'kirby-fthrow-uair',
        kind: 'bnb',
        title: 'Forward Throw → Up Air',
        start: 50,
        ...
        tip: 'Laut SmashWiki sind Up Air und Final Cutter bei mittleren Prozenten die verlässlichsten Folgen aus dem Forward Throw.',
        source: wiki('Kirby_(SSBU)'),
      },
    ],
  },
